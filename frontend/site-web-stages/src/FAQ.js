...
function FAQ() {
    return (
        <div><h2>Foire aux questions - FAQ</h2>
              ...
              <h4>Quel est l'horaire de l'étudiant durant les stages?</h4>
               <br/>
			   <p>L'étudiant doit respecter l'horaire de l'entreprise durant son stage.</p>
               <br/>
			   <h4>Est-ce que l'étudiant travaille pendant les journées pédagogiques et
			  les journées de rattrapage?</h4>
              <br/>
              <p>L'étudiant doit respecter l'horaire de l'entreprise durant son stage et ce même
			  durant les journées pédagogiques et de rattrapage. </p>
              <br/>
              <h4>Quelle est la durée d'un stage de fin d'études?</h4>
               <br/>
			   <p>La durée du stage est de 15 semaines pour les deux profils de sortie (réseaux et programmation). </p>
               <br/>
			   <h4>Quelles sont les dates prévues pour les stages?</h4>
               <br/>
